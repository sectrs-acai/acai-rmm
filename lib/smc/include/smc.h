...
#define SMC_ASC_MARK_SECURE_DEV		SMC64_STD_FID(RMM_EL3, U(8))
#define SMC_REQUEST_DEVICE_OWNERSHIP SMC64_STD_FID(RMM_EL3, U(11))
#define SMC_ASC_ATTACH_DEV		SMC64_STD_FID(RMM_EL3, U(10))
